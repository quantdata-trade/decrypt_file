...
var getParam = (function () {
        ...
        return function (method, obj, app_id) {
            var clienttype = 'WEB';
            ...
            var param = {
                ...
                object: obj,
                secret: hex_md5(app_id + method + timestamp + clienttype + JSON.stringify(ObjectSort(obj)))
            };
...
// 参数解密，BASE64解码 > DES解码 > AES解码 > BASE64解码
function decodeData(data, des_key, des_iv, aes_server_key, aes_server_iv) {
...
// 定义方法，参数加密，仅BASE64
function getEncryptedData1(method, city, month, app_id) {
    var param = {};
    param.city = city;
    param.month = month;
    param = getParam(method, param, app_id);
    return param;
}

// 定义方法，参数加密，BASE64 + AES
function getEncryptedData2(method, city, month, app_id, key, iv) {
    var param = {};
    param.city = city;
    param.month = month;
    param = getParam(method, param, app_id);
    param = AES.encrypt(param, key, iv);
    return param;
}

// 定义方法，参数加密，BASE64 + DES
function getEncryptedData3(method, city, month, app_id, key, iv) {
    var param = {};
    param.city = city;
    param.month = month;
    param = getParam(method, param, app_id);
    param = DES.encrypt(param, key, iv);
    return param;
}
